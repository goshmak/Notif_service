...
__SQLite (по умолчанию, прототип)__
...
__Сообщения VK не отправляются__
...
__Задачи остаются в статусе PENDING__
